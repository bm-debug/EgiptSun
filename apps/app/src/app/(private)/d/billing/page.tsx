  ...
  React.useEffect(() => {
    const fetchTransactions = async () => {
      try {
        ...
        const response = await fetch('/api/altrp/v1/s/wallet-transactions', {
          credentials: 'include',
        })
        ...
        const data = await response.json() as { success?: boolean; data?: Transaction[] }
        ...
        <div className="flex gap-2">
            ...
            <ResponsiveDialogContent className="h-[calc(100svh-16px)] w-[560px] max-w-[95vw] overflow-hidden p-0">
              <div className="flex h-full flex-col">
                <ResponsiveDialogHeader className="px-6 pt-6">
                  <ResponsiveDialogTitle>Пополнить кошелек</ResponsiveDialogTitle>
                  <ResponsiveDialogDescription>
                    Введите сумму для пополнения
                  </ResponsiveDialogDescription>
                </ResponsiveDialogHeader>
                <form onSubmit={handleDeposit} className="flex min-h-0 flex-1 flex-col">
          ...
          >
            ...
            <ResponsiveDialogContent className="h-[calc(100svh-16px)] w-[560px] max-w-[95vw] overflow-hidden p-0">
              <div className="flex h-full flex-col">
                <ResponsiveDialogHeader className="px-6 pt-6">
                  <ResponsiveDialogTitle>Вывести средства</ResponsiveDialogTitle>
                  <ResponsiveDialogDescription>
                    Введите сумму для вывода
                  </ResponsiveDialogDescription>
                </ResponsiveDialogHeader>
                <form onSubmit={handleWithdraw} className="flex min-h-0 flex-1 flex-col">
                  <div className="min-h-0 flex-1 overflow-y-auto px-6 py-4">
                    <div className="space-y-4">
                      <div className="space-y-2">
