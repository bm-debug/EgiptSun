...
import { AddInventoryToLocation } from '@/packages/components/blocks-app/s/AddInventoryToLocation'
...
export default function Page() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setError(null)
      try {
        const response = await fetch(`/api/store/v2/s/products?page=${page}&limit=${PAGE_SIZE}&withInventory=true`, {
          credentials: 'include',
        })
