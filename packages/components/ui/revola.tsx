...
const ResponsiveDialog = ({
  ...
  const effectiveDirection = getEffectiveDirection(direction, dir);
      ...
      <ResponsiveDialogPortal>
        ...
        >
          ...
          {shouldShowCloseButton && (
            <ResponsiveDialogClose
              className={cn(
                "ring-offset-background focus-visible:ring-ring data-[state=open]:bg-accent absolute top-4 end-4 rounded-sm opacity-70 backdrop-blur-sm transition-opacity hover:opacity-100 focus:ring-offset-2 focus:outline-none focus-visible:ring-2 disabled:pointer-events-none data-[state=open]:text-white",
                closeButtonClassName,
              )}
            >
              <X className="size-4" />
