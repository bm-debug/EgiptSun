        ...
        <NavigationMenuItem>
          ...
          <NavigationMenuContent>
            <ul className="grid gap-3 p-1 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
              ...
              <ListItem href={{ pathname: "/docs" }} title="Introduction">
                Re-usable components built using Radix UI and Tailwind CSS.
              </ListItem>
              <ListItem href={{ pathname: "/docs/installation" }} title="Installation">
                How to install dependencies and structure your app.
              </ListItem>
              <ListItem href={{ pathname: "/docs/primitives/typography" }} title="Typography">
